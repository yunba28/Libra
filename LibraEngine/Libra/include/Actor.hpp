...
namespace Libra
{
	...
	public:
		...
		/// @brief 指定した文字列のいずれかがActorの持つタグと等しいか
		bool compareAnyTag(const Array<String>& _tag)const noexcept;

		/// @brief 指定した文字列のすべてがActorの持つタグと等しいか
		bool compareAllTag(const Array<String>& _tag)const noexcept;
